package com.devsancho.slidebanner.adapters
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): View {
        ...
        if (imageList!![position].imageUrl == null) {
            ...
            Picasso.get()
                ...
                .fit()
                .transform(RoundedTransformation(radius, 0, RoundedTransformation.CornerType.BOTTOM))
                //.placeholder(placeholder)
                .error(errorImage)
                .into(imageView)
        }
