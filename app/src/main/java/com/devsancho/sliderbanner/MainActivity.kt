...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        slide_banner.setImageList(imageList)
        slide_banner.setItemClickListener(object : ItemClickListener {
            override fun onItemSelected(position: Int) {
                Snackbar.make(main, position.toString(), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show()
            }
        })
    }
